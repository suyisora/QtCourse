...
"}"));
        ...
        mainFrame->setWidget(0, QFormLayout::ItemRole::LabelRole, label_2);

        serverEdit = new QLineEdit(loginFrame);
        serverEdit->setObjectName("serverEdit");

        mainFrame->setWidget(0, QFormLayout::ItemRole::FieldRole, serverEdit);

        label_3 = new QLabel(loginFrame);
        label_3->setObjectName("label_3");

        mainFrame->setWidget(1, QFormLayout::ItemRole::LabelRole, label_3);

        usernameEdit = new QLineEdit(loginFrame);
        usernameEdit->setObjectName("usernameEdit");

        mainFrame->setWidget(1, QFormLayout::ItemRole::FieldRole, usernameEdit);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        titleLabel->setText(QCoreApplication::translate("MainWindow", "\345\221\250\351\224\220\351\223\226\347\232\204\350\201\212\345\244\251\345\256\244", nullptr));
