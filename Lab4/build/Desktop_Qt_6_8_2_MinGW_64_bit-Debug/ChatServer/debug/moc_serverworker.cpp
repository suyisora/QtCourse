...
static constexpr auto qt_meta_stringdata_ZN12ServerWorkerE = QtMocHelpers::stringData(
    "ServerWorker",
    "logMessage",
    "",
    "msg",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ServerWorkerE[] = {
...
Q_CONSTINIT const QMetaObject ServerWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ServerWorkerE.offsetsAndSizes,
    qt_meta_data_ZN12ServerWorkerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ServerWorkerE_t,
        // Q_OBJECT / Q_GADGET
...
void ServerWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ServerWorker::*)(const QString & );
            if (_q_method_type _q_method = &ServerWorker::logMessage; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ServerWorker::*)(ServerWorker * , const QJsonObject & );
            if (_q_method_type _q_method = &ServerWorker::jsonReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (ServerWorker::*)();
            if (_q_method_type _q_method = &ServerWorker::disconnectedFromClient; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *ServerWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ServerWorkerE.stringdata0))
